        ...
        <div class="colgroup typecho-page-main manage-metas">
            ...
            <div class="row">
                <div class="col-mb-12 col-tb-8" role="main">
                    ...
                    $keywords = $request->get('keywords', "H");
                    if (!empty($keywords)) {
                        $select->where("name LIKE ?", "%$request->keywords%");
                    }
                    $links = $db->fetchAll($select);
                    $total = $db->fetchObject($db->select(array('COUNT(1)' => 'num'))->from('table.links'))->num;
                    ?>
                    ...
                    <form method="post" name="manage_categories" class="operate-form">
                        <div class="typecho-list-operate clearfix">
                            ...
                            <div class="search" role="search">
                                <?php if ('' != $request->keywords): ?>
                                    <a href="<?php $options->adminUrl('extending.php?panel=Links%2Fmanage-links.php'); ?>"><?php _e('&laquo; 取消筛选'); ?></a>
                                <?php endif; ?>
                        ...
                        <?php if (!empty($links)): ?>
                            ...
                            <ul class="typecho-pager">
                                <?php Links_Plugin::pageNav($total); ?>
                            </ul>
                        <?php endif; ?>
                    </form>
                </div>
                <div class="col-mb-10 col-tb-4" role="form">
